...
var layers = [
  ...
  new TileLayer({
    source: new TileWMS({
      url: 'http://119.59.125.189:8080/mapservice/gis/wms?',
      params: {
        'LAYERS': 'gis:province',
        'TILED': true
      },
  ...
  new VectorTileLayer({
    ...
    source: new VectorTileSource({
      ...
      url: 'http://119.59.125.189/mapservice/gwc/service/tms/1.0.0/' +
        'gis:raintam2557@EPSG:900913@pbf/{z}/{x}/{-y}.pbf'
    }),
    style: new Style({
      stroke: new Stroke({
        color: 'red',
...
const jsonPro = `http://119.59.125.189:8080/mapservice/gis/wms?service=WFS&version=1.0.0&request=GetFeature&typeName=gistnu:hospital&outputFormat=application%2Fjson`;
