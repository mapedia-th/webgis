        ...
        <sld:UserStyle>
            ...
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    <sld:Name>ขอบเขตตำบล</sld:Name>
                  <!-- Scale Set Zoom -->
                    <sld:MaxScaleDenominator>269231</sld:MaxScaleDenominator>
                    <sld:PolygonSymbolizer>
                        <sld:Stroke>
                            <sld:CssParameter name="stroke">#C5C5C5</sld:CssParameter>
                            <sld:CssParameter name="stroke-opacity">0.9</sld:CssParameter>
                            <sld:CssParameter name="stroke-dashoffset">3</sld:CssParameter>
